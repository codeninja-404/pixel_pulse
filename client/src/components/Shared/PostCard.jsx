  ...
  return (
    <div className="group relative w-[370px]  border border-teal-500 h-[300px] overflow-hidden rounded-lg  my-2">
      ...
      <div className="p-3 flex flex-col ga-2 ">
        ...
        <Link
          className="z-10 group-hover:bottom-0 bottom-[-200px] absolute left-0 right-0 border border-teal-500 text-white bg-slate-400 hover:bg-teal-500 transition-all duration-300 text-center py-2 rounded-md !rounded-tl-none m-2"
          to={`/post/${post.slug}`}
        >
          Read airtcle{" "}
        </Link>
